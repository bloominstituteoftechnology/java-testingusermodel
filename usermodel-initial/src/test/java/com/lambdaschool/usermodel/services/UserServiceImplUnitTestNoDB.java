...
public class UserServiceImplUnitTestNoDB {
  ...
  public void findUserById() {
    ...
    assertEquals("admintest", userService.findUserById(1).getUsername());
  }
  ...
  public void findByNameContaining() {
    Mockito.when(userrepos.findByUsernameContainingIgnoreCase("admintest"))
        .thenReturn(userList);
    assertEquals(3, userService.findByNameContaining("admintest").size());
  }
  ...
  public void findByName() {
    ...
    assertEquals(1, userService.findByName("barnbarntest").getUserid());
  }
